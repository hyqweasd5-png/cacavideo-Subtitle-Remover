...
This repository currently contains a reusable skill package for integrating the CacaVideo async media-pull API.
...
- `caca-link-pull-api/`
  ...
  - a Python CLI helper for submit, status polling, and end-to-end tests
- `接口文档Test.md`
  - original source document used to build the skill
...
- local skill hosts: mount or copy the folder where the host scans for `SKILL.md`
...
The included CLI can also be run directly for manual testing.
...
The skill package was validated locally with:
